...
async def admin_profile(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Пустые теги премиум-эмодзи
    nick_emoji = '<tg-emoji emoji-id="5210956306952758910"></tg-emoji>'
...
async def friend_list(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    bot_username = (await context.bot.get_me()).username
    friends_emoji = '<tg-emoji emoji-id="5282843764451195532"></tg-emoji>'
            ...
            if resp.status_code == 200:
                ...
                if trade_id:
                    ...
                    withdraw_text = (
                        ...
                        f"• <tg-emoji emoji-id=\"5461117441612462242\"></tg-emoji> <b>Игрок:</b> {html.escape(nick)} (@{html.escape(username)})\n"
                        f"• <tg-emoji emoji-id=\"5436113877181941026\"></tg-emoji> <b>Скин:</b> {html.escape(skin_name)}\n"
