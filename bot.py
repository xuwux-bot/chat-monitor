...
authorised_users: Set[int] = set()  # <-- теперь храним ID пользователей, а не чатов
monitor_running = False
monitor_task: Optional[asyncio.Task] = None
sender_ids: Dict[int, str] = {}      # по-прежнему chat_id -> sender_id (для отправки в игру)
...
def main():
    ...
    print("🚀 Монитор-бот с блокировкой трейдов, парсером и NUKE запущен. Нажми Ctrl+C для остановки.")
    app.run_polling()
