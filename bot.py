...
async def show_item_menu(update: Update, context: ContextTypes.DEFAULT_TYPE,
    ...
    text += f"<tg-emoji emoji-id=\"5422439311196834318\">💡</tg-emoji> {mod_name}\n"
...
async def item_action_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "withdraw":
        ...
        params = {
            ...
            "playerID": owner_id,                         # ID получателя (игрока)
            ...
            if resp.status_code == 200:
                ...
                if trade_id:
                    ...
                    withdraw_text = (
                        ...
                        f"• <b>Игрок:</b> {nick} (@{username})\n"
                        f"• <b>Скин:</b> {skin_name}\n"
                        f"• <b>Сообщение в трейде:</b> <code>{msg_code}</code>\n"
                        f"• <b>ID трейда:</b> <code>{trade_id}</code>"
                    )
